...
namespace SphereStudio.UndoRedo
{
    ...
    internal class TileRemovePage : HistoryPage
    {
        ...
        MapDocumentView _parent;

        public TileRemovePage(MapDocumentView parent, List<Tile> tiles, short startindex, List<short[,]> layertiles)
        {
            _tiles = tiles;
            _parent = parent;
    ...
    internal class TileAddPage : HistoryPage
    {
        ...
        public TileAddPage(MapDocumentView parent, List<Tile> added, short startindex, List<short[,]> layertiles)
        {
            _parent = parent;
            _added = added;
            _startindex = startindex;
