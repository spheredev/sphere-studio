...
namespace SphereStudio.Formats
{
    /// <summary>
    ...
    public class Entity : IDisposable
    {
        ...
        public Entity(EntityType type)
        {
            ...
            if (type == EntityType.Person)
                _graphic = new Bitmap(Resources.PersonIcon);
            else
                _graphic = new Bitmap(Resources.TriggerIcon);
        }
        ...
        {
            if (Type == EntityType.Trigger) return Resources.TriggerIcon;
