...
namespace SphereStudio.DocumentViews
{
    ...
    partial class TextDocumentView : TextView, IStyleAware
    {
        ...
        private QuickFind quickFinder;
        private Scintilla scintilla = new Scintilla();
        private bool useAutoComplete;

        public TextDocumentView(PluginMain plugin, bool highlight = false)
        {
            InitializeComponent();
            ...
            this.plugin = plugin;
            quickFinder = new QuickFind(this, scintilla);
