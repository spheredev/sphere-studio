...
{
    partial class SpritesetView : DocumentView
    {
        #region attributes
        ...
        public SpritesetView(PluginMain main)
        {
            InitializeComponent();
            InitializeDocking();
        ...
        public void Init()
        {
            ...
            SpriteDrawer.ZoomIn();
            SpriteDrawer.ZoomIn();
            _tilesetCtrl = new TilesetControl2 { Tileset = Formats.Tileset.FromSpriteset(_sprite), CanInsert = false };
            _tilesetCtrl.ZoomIn();
